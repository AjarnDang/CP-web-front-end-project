...
<head>
    ...
    <title>E-Learning College of Computing | Khon Kaen University</title>
    ...
    <nav>
        ...
        <div class="brand">
            ...
            <ul class="nav-list">
                ...
                <li>
                    <button class="btn" onclick="document.location='index.php'">Log out</button>
                </li>
            </ul>
        </div>
    </nav>
